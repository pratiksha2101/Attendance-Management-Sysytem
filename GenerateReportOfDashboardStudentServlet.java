...
public class GenerateReportOfDashboardStudentServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            PdfWriter.getInstance(document, new FileOutputStream("D://Student_Attendance.pdf"));
            document.open();
            ...
            String queryWithAttendance = "select id,username,todaydate,sname,rollno,course,semester,branch,attendance from attendancems_student where username = '"+username+"' and todaydate = '"+todaydate+"' and attendance = '"+attendance+"';";
            String queryWithoutAttendance = "select id,username,todaydate,sname,rollno,course,semester,branch,attendance from attendancems_student where username = '"+username+"' and todaydate = '"+todaydate+"';";
